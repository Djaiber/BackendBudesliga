...
@pytest.mark.asyncio
async def test_publish_sends_event_to_eventbridge(
    publisher: EventBridgePublisher, mock_events_client
):
...
@pytest.mark.asyncio
async def test_publish_serializes_detail_to_json(
    publisher: EventBridgePublisher, mock_events_client
):
...
@pytest.mark.asyncio
async def test_publish_uses_configured_event_bus_name(
    publisher: EventBridgePublisher, mock_events_client
):
...
@pytest.mark.asyncio
async def test_publish_handles_complex_nested_detail(
    publisher: EventBridgePublisher, mock_events_client
):
